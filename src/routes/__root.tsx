...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tile Odyssey" },
      { name: "description", content: "Aventura de peças em 12 ilhas mágicas com o Tilo." },
      { name: "theme-color", content: "#8fd8ff" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Tile Odyssey" },
