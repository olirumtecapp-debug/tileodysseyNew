//#region node_modules/.nitro/vite/services/ssr/assets/data-BQohRghz.js
var SYMBOLS = [
	{
		id: "apple",
		glyph: "🍎",
	...
	},
	{
		id: "crown",
		glyph: "👑",
		name: "Coroa Esquecida",
		category: "Tesouros"
	},
	{
		id: "compass",
		glyph: "🧭",
		name: "Bússola do Tilo",
		category: "Tesouros"
	},
	{
		id: "lantern",
...
var symbolById = (id) => SYMBOLS.find((s) => s.id === id);
var WORLDS = [
	{
		id: "bosque",
...
var worldById = (id) => WORLDS.find((w) => w.id === id);
...
function buildLevel(worldId, index) {
	...
	return {
		...
		objective: objective.kind === "collect" ? {
			...objective,
...
//#endregion
export { worldById as a, symbolById as i, WORLDS as n, buildLevel as r, SYMBOLS as t };
